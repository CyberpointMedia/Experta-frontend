...
class WithdrawCreditsPage extends StatefulWidget {
  @override
  _WithdrawCreditsPageState createState() => _WithdrawCreditsPageState();
}
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 8), // Add space between coin and entered amount
            Expanded(
              child: TextFormField(
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10.v), // Optional space between heading and container
          Container(
